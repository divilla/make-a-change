...
```go
// ExportedName describes what the exported declaration does.
// State parameter constraints, returned values, errors, and relevant side effects
// in prose, using the declaration's actual name. Explain why where useful.
// {actual Go declaration and implementation from the codebase}
```
